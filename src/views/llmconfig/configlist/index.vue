...
const PROVIDER_MODELS = {
  ...
  openai_gpt1: { label: 'GGB', abbr: 'OA', color: '#10a37f', models: ['gpt-5.2','gpt-5.1', 'gpt-5'] },
  openai_gpt2: { label: 'infiniteai', abbr: 'OA', color: '#10a37f', models: ['gpt-5.2','gpt-5.1', 'gpt-5'] },
  gpt3: { label: '薄荷', abbr: 'OA', color: '#10a37f', models: ['gpt-5.2','gpt-5.2-high','gpt-5.1','gpt-5.1-high', 'gpt-5','gpt-5-high'] },
  gpt4: { label: 'hotaruapi', abbr: 'OA', color: '#10a37f', models: ['gpt-5.2','gpt-5.2-high','gpt-5.1','gpt-5.1-high', 'gpt-5','gpt-5-high'] },
  openai_gpt5: { label: 'KFC', abbr: 'OA', color: '#10a37f', models: ['gpt-5.2','gpt-5.2-high','gpt-5.1','gpt-5.1-high', 'gpt-5','gpt-5-high'] },
  gpt6: { label: '哈基米', abbr: 'OA', color: '#10a37f', models: ['[满血A]gemini-3-pro-preview','[福利]gemini-3-flash-preview','[福利]gemini-3-flash-preview-thinking','gpt-5.2','gpt-5.2-high','gpt-5.1','gpt-5.1-high', 'gpt-5','gpt-5-high'] },
  gpt7: { label: '玩票', abbr: 'OA', color: '#10a37f', models: ['gpt-5.2-codex','gpt-5.3-codex','gemini-3.1-flash-lite-preview','gemini-3-flash','gpt-5.2','gpt-5.2-high','gpt-5.1','gpt-5.1-high', 'gpt-5','gpt-5-high'] },
